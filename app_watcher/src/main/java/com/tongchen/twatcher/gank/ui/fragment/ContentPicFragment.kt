...
import kotlinx.android.synthetic.main.gank_fragment_content_pic.*
 ...
 * Desc:
 */
class ContentPicFragment : BaseFragment(), EasyPermissions.PermissionCallbacks {
    ...
    override fun bindLayout() = R.layout.gank_fragment_content_pic
