...
import com.tongchen.beauty.util.ScreenUtil;
...
public class KDrawerLayout extends ViewGroup {
    ...
    public KDrawerLayout(Context context) {
        this(context, null, 0);
    }

    public KDrawerLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public KDrawerLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        mScroller = new Scroller(context);

        //设置侧滑菜单距离屏幕右侧的距离
        mMenuRightPadding = ScreenUtil.dip2px(100);

        mScreenWidth = ScreenUtil.screenWidth;
        mScreenHeight = ScreenUtil.screenHeight;
    }
